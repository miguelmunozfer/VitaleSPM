Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/miguelmunozfer/VitaleHealthSDK" # Cambia por la URL real
  spec.license      = { :type => "MIT", :file => "LICENSE" } # Ajusta la licencia según corresponda
  spec.author       = { "Miguel Muñoz" => "tuemail@example.com" }
  spec.platform     = :ios, "12.0"
  spec.source       = { :git => "https://github.com/miguelmunozfer/VitaleHealthSDK.git", :tag => "#{spec.version}" }
